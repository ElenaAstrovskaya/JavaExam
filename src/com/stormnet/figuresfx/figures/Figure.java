...
public abstract class Figure implements Drawable {
    ...
    public static final int FIGURE_TYPE_STAR1       = 3;
    public static final int FIGURE_TYPE_STAR2       = 4;
    public static final int FIGURE_TYPE_SQUARE      = 5;
    public static final int FIGURE_TYPE_RHOMBUS     = 6;
    public static final int FIGURE_TYPE_ELLIPSE     = 7;
